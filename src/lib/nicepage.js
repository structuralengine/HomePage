                ...
                if (!this._triggerSlideEvent(f, v).isDefaultPrevented())
                  if (a && f) {
                    ...
                    if (s.default(this._element).hasClass(B)) {
                      ...
                      s.default(a).removeClass(U),
                        s.default(f).addClass(U),
                        (this._isSliding = false),
    ...
    s(document).on("click", ".u-video-poster, .u-video video", function (t) {
      ...
      s(function () {
        s(
          ...
          s(
            ".embed-responsive-item:not(lazyloading, lazyloaded) + .u-video-poster"
          ).each(function () {
    ...
    !(function (a, factory) {
      ...
      return function (t, e, items, i) {
        ...
        var u = function () {
          ...
          Ve = function (t, e) {
            return (
              (We.prevent = !Ue(t.target, l.isClickableElement)),
            ...
            if (!V)
              if (t.type.indexOf("touch") > -1) {
                if (t.touches && t.touches.length > 0)
                  if (((Ye[0] = Ze(t.touches[0], $e)), t.touches.length > 1))
                    Ye[1] = Ze(t.touches[1], Ke);
              } else
                ($e.x = t.pageX), ($e.y = t.pageY), ($e.id = ""), (Ye[0] = $e);
            else
              (Qe = 0),
            ...
            if (ye) {
              ...
              if (0 !== t)
                if (
                  ...
                  if (!Ee) return;
                  if (Ie) {
                    if (((Ie = false), Math.abs($t.x) >= Vt))
                      $t.x -= ye[0].x - Yt.x;
                    if (Math.abs($t.y) >= Vt) $t.y -= ye[0].y - Yt.y;
                  }
                  if (((Kt.x = Xt.x), (Kt.y = Xt.y), 0 === $t.x && 0 === $t.y))
                    return;
          ...
          oi = function (t) {
            ...
            if (((ye = null), pe || ce || Se || oe)) {
              ...
              if ((te.calculateSwipeSpeed("x"), !oe)) {
                ...
                if (Ge() < l.verticalDragRange) o.close();
                else {
                  var p = w.y,
                    h = Oe;
                  Bt(
            ...
            var t,
              ...
              i = {
                ...
                panAnimLoop: function () {
                  if (Pt.zoomPan)
                    if (
                      ((Pt.zoomPan.raf = G(i.panAnimLoop)),
                      (i.now = dt()),
            ...
            handleMouseWheel: function (t) {
              if (T <= o.currItem.fitRatio) {
                if (l.modal)
                  ...
                  else if (W && Math.abs(t.deltaY) > 2) (p = true), o.close();
                return true;
              }
            ...
            initHistory: function () {
              if ((n.extend(l, Pi, true), l.history)) {
                ...
                var t = function () {
                  if (((Ui = true), !ji))
                    if (Xi) history.back();
                    else if (Wi) Gi.hash = Wi;
                    else if ($i)
                      history.pushState(
                        "",
                        document.title,
                        Gi.pathname + Gi.search
                      );
                    else Gi.hash = "";
                  Yi();
                };
        ...
        var i = this,
          ...
          k = function (t) {
            ...
            for (
              ...
              if (((n = $[s]), n.onTap && o.indexOf("pswp__" + n.name) > -1))
                n.onTap(), (a = true);
            if (a) {
                ...
                if (o)
                  for (var a = o.length, s = 0; s < a; s++) {
                    ...
                    for (var l = 0; l < $.length; l++)
                      if (((n = $[l]), i.indexOf("pswp__" + n.name) > -1))
                        if (x[n.option]) {
                          if (
      ...
      !(function (e, i, n) {
        ...
        (o.prototype.refresh = function (t) {
          var e,
            ...
            a = false;
          if (t === n)
            (a = true), (Lt = []), ($t = 0), (t = i.getElementsByTagName("*"));
          ...
          for (e = 0, o = t.length; e < o; e++) {
            ...
            if (el.attributes) {
              ...
              if (l.length) {
                ...
                else (id = el[F] = $t++), (C = el.style.cssText), (T = _t(el));
                (Lt[id] = {
                  element: el,
                  styleAttr: C,
                  classAttr: T,
          ...
          (o.prototype.setScrollTop = function (t, i) {
            if (((Gt = true === i), Yt)) Qt = l.min(l.max(t, 0), Mt);
            else e.scrollTo(0, t);
            return At;
          }),
        ...
        a.setStyle = function (el, t, e) {
          var style = el.style;
          if (((t = t.replace(B, U).replace("-", "")), "zIndex" === t))
                    ...
                    if (
                      ...
                      if (!y)
                        if (
                          ...
                          (b = a.hFac),
                          (B = null),
                          j < w && X < 1 && G > 2 && g > 2 && !i.hidden)
                        )
                          (j = w), (G = 0);
                        else if (g > 1 && G > 1 && X < 6) j = y;
                        else j = Z;
                      if (v !== p)
                        (A = innerWidth + p * b),
                          (M = innerHeight + p),
